document.addEventListener("DOMContentLoaded", () => {
  ...
  async function enviarFormulario(event) {
    ...
    const formData = {
      nomeDoFornecedor: document.getElementById("nomeFornecedor").value,
      cnpj: document.getElementById("cnpj").value,
      telefone: document.getElementById("telefone").value,
      email: document.getElementById("email").value,
      tipoDeFornecimento: document.getElementById("tipoDeFornecimento").value,
      endereco: {
    ...
    try {
      const response = await fetch("https://localhost:7165/api/Fornecedores/", {
        method: "POST",
        headers: {
